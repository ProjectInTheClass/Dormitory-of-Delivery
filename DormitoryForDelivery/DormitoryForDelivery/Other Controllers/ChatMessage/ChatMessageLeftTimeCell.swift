...
class ChatMessageLeftTimeCell: UICollectionViewCell {
    ...
    func setAnchors() {
        ...
        containerView.rightAnchor.constraint(equalTo: rightAnchor, constant: -6).isActive = true
        ...
        timeLabel.rightAnchor.constraint(equalTo: containerView.leftAnchor, constant: -5).isActive = true
